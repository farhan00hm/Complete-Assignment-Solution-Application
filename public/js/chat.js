...
const USER_TYPE = $('meta[name=user_type]').attr("content");
...
var chatbox = {
    ...
    template: `
        <div class="chat_box" v-bind:id="'chatbox-' + cChat.id" style="left:270px; float: right !important; width: 750px !important; margin-top: -390px !important; margin-right: 50px;">
            <div class="box box-primary direct-chat direct-chat-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">{{ cChat.first_name }}</h3> <span>{{ typing }}</span>
