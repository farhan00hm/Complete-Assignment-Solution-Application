(function ($) {
    ...
    $(document).ready(function () {
        ...
        $(".ripple-effect, .ripple-effect-dark").on("click", function (e) {
            ...
            rippleDiv.css({ top: rippleY - rippleDiv.height() / 2, left: rippleX - rippleDiv.width() / 2 }).appendTo($(this));
        ...
        userMenuScrollbar();
        tippy("[data-tippy-placement]", { delay: 100, arrow: true, arrowType: "sharp", size: "regular", duration: 200, animation: "shift-away", animateFill: true, theme: "dark", distance: 10 });
                ...
                $(".tabs").each(function () {
                    ...
                    function changePos() {
                        ...
                        thisTab
                            .find(".tab-hover")
                            .stop()
                            .css({ left: activePos.left, width: thisTab.find(".tabs-header .active").width() });
                    }
                    changePos();
        ...
        $(".keywords-container").each(function () {
            ...
            function addKeyword() {
                ...
                if ($(".keywords-list").children("span").length < 3) {
        ...
        var ruploadButton = { $button: $(".ruploadButton-input"), $nameField: $(".ruploadButton-file-name") };
        ruploadButton.$button.on("change", function () {
            _rpopulateFileField($(this));
        });
        function _rpopulateFileField($button) {
            var selectedFile = [];
            for (var i = 0; i < $button.get(0).files.length; ++i) {
                selectedFile.push($button.get(0).files[i].name + "<br>");
            }
            ruploadButton.$nameField.html(selectedFile);
        }
        ...
        $(".default-slick-carousel").slick({
            ...
            responsive: [
                ...
                { breakpoint: 993, settings: { slidesToShow: 2, slidesToScroll: 2, dots: true, arrows: false } },
        ...
        $(".testimonial-carousel").slick({
            ...
            responsive: [
                ...
                { breakpoint: 993, settings: { centerPadding: "15%", slidesToShow: 1 } },
        ...
        $(".logo-carousel").slick({
            ...
            responsive: [
                ...
                { breakpoint: 992, settings: { slidesToShow: 3, dots: true, arrows: false } },
        ...
        $(".blog-carousel").slick({
            ...
            responsive: [
                ...
                { breakpoint: 992, settings: { slidesToShow: 2, dots: true, arrows: false } },
                { breakpoint: 768, settings: { slidesToShow: 1, dots: true, arrows: false } },
            ],
        });
