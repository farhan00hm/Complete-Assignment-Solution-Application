        ...
        <div class="row">
            <div class="col-xl-8 offset-xl-2">
                <div class="login-register-page">
                    ...
                    <!-- Button -->
                    <button id="onboardParent" class="button full-width button-sliding-icon ripple-effect margin-top-10" type="submit" form="login-form">Create Profile <i class="icon-material-outline-arrow-right-alt"></i></button>
                </div>
            </div>
        </div>
    </div>
