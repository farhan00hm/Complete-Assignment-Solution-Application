...
@section('content')
    ...
    <div class="dashboard-box main-box-in-row">
        <div class="headline">
            <h3><i class="icon-feather-bar-chart-2"></i> Archive @if(Auth::user()->user_type == "Student")Homeworks @else Projects @endif
        ...
        <div class="contentdashboard-box main-box-in-row table-responsive" style="overflow-x:auto; padding: 10px;">
            @if($hws->count() == 0)
                <div class="row">
                    <div class="col-md-12">
                        <p style="padding: 20px;">You have no archive @if(Auth::user()->user_type == "Student")homeworks @else projects @endif.</p>
                    </div>
                </div>
            @else
