...
@section('content')
    ...
    <div class="dashboard-box main-box-in-row">
        <div class="headline">
            <h3><i class="icon-feather-bar-chart-2"></i> Open @if(Auth::user()->user_type == "Student")Homework @else Project @endif
                <a href="/homeworks/new" class="button mb-10" style="float: right; color: #fff; line-height: 20px; box-shadow: none;">+ Post</a>
            </h3>
        </div>
        <div class="contentdashboard-box main-box-in-row table-responsive" style="overflow-x:auto; padding: 10px;">
            @if($hws->count() == 0)
                <div class="row">
                    <div class="col-md-12">
                        <p style="padding: 20px;">You have no open homeworks. Use the '+ Post' button above to post a homework</p>
                    </div>
                </div>
            @else
                        ...
                        <tbody>
                            @foreach($hws as $hw)
                                <tr>
                                    ...
                                    <td>
                                        <a style="color: #00a554" href="/homeworks/edit/{{ $hw->uuid }}" title="Edit homework">
