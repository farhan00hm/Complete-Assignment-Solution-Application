...
@section('content')
    <div class="dashboard-box main-box-in-row" style="min-height: 550px;">
        <div class="headline">
         ...
         {{-- @if($hw->solution->refund) --}}
           
                 <a href="#" class="refund button mb-10" id="refund"  data-code="{{ $hw->uuid }}" title="Request for refund" style="float: right; color: #fff; line-height: 20px; box-shadow: none;">+ Request Refund</a>
                      ...
                      <div class="row">
                             ...
                             <fieldset>
                                  <div class="some-class">
                                    <?php if(@$hw->solution->refund == 0) { ?>
                                    <input type="radio" class="radio" name="refund" value="0"  id="r1" checked />
                                    <label for="y">Full Refund</label>
                                    <?php  } elseif (@$hw->solution->refund == 1) { ?>
                                    <input type="radio" class="radio" name="refund" value="1" id="r2" checked />
                                    <label for="z">Partial Refund</label>
                                  </div>

                                 <div class="text">
                                    <p> 
                                        Acceptness  {{ @$hw->solution->acceptness }}%
                                    </p>
                                </div>
                                <?php } ?>
                                </fieldset>
    ...
    <script src="{{ asset('member/js/pdfobjects.min.js') }}"></script>
      ...
      <script>
        $(document).ready(function(){
            $(".headline").on("click", ".refund", function(e){
                e.preventDefault();
